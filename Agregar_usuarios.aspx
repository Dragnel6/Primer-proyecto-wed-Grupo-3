                ...
                <table class="auto-style1">
                    <tr>
                        <td class="auto-style21">
                            <asp:Label ID="Label8" runat="server" BackColor="White" CssClass="auto-style23" Font-Size="XX-Large" Text="Registro de usuarios"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="auto-style21">
                            <asp:Label ID="Label4" runat="server" BackColor="White" Font-Size="Large" Text="Escriba un nombre de usuario" CssClass="auto-style23"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="auto-style21">
                            <asp:Label ID="Label5" runat="server" BackColor="White" Font-Size="Large" Text="Seleccione el tipo de usuario" CssClass="auto-style23"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style7">
                    ...
                    <tr>
                        <td class="auto-style21">
                            <asp:Label ID="Label6" runat="server" BackColor="White" Font-Size="Large" Text="Escribe una clave" CssClass="auto-style23"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style7">
                    ...
                    <tr>
                        <td class="auto-style21">
                            <asp:Label ID="Label7" runat="server" BackColor="White" Font-Size="Large" Text="Confirma tu clave" CssClass="auto-style23"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style7">
                    ...
                    <tr>
                        <td class="auto-style7">
                            ...
                            <asp:Button class="btn third" ID="btRegistrar" runat="server" Height="61px" OnClick="btRegistrar_Click" Text="Registrar " Width="199px" />
                                </div>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style20">
                            <asp:Label ID="lblUsuarios" runat="server" CssClass="auto-style23" Text="Label" BackColor="White" Font-Size="X-Large"></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
